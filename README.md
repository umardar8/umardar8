...
|:---:|:---:|:---|
| **Code Sorcery** | Lvl 99 | `Full Stack Dev`, `MERN` |
| **Freelancing** | Lvl 85 | `Fiverr`, `Remote Projects` |
| **Mentorship** | Lvl 99 | `Educator`, `MUET SW`, `PITP`, `LUMHS` |
| **Creativity** | Lvl 85 | `Canva`, `Content Creation` |
| **Stamina** | Lvl 10 | `Coffee Consumption`, `All-Nighters` |
| **Weapon** | Legendary | `VS Code`, `Android Studio` |
